						...
						<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Question Category</label>
							  <div class="controls">
								<select name="que_cat" placeholder="Select the Question Category">
									<?php
									
									$sq="select * from que_category";
									$re=$conn->query($sq);
							...
							<div class="control-group">
								...
								<div class="controls">
								 <input type="file" name="file_name"  class="span6 typeahead" id="typeahead">
								</div>
							  </div>
