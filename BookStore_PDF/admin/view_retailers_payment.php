...
$RetailersBalanceList = $fn->GetRetailersPaymentData();
//exit;
?>
<!--Content-->
<div class="content-wrapper">
   <div class="row">
    <div class="page-title">
        ...
        <div class="col-lg-8">
                <div>
                <h1><i class="fa fa-dashboard"></i> Retailers Payment Management</h1>
            </div>
            <div>
...
//exit;
                    ...
                    if ($_REQUEST['method'] == '') { ?>
                <div class="col-lg-6">
                    <a href='view_retailers_payment&method=add' class="btn btn-sm btn-success btn-labeled text-uppercase waves pull-right waves-effect waves-float" title="Click here to add new record"><span class="btn-label"><i class="fa fa-plus-square"></i></span>  Add New</a>
                </div>
                <div class="col-lg-6">
                     <a href='view_retailers_payment&method=OpeningBalance' class="btn btn-sm btn-success btn-labeled text-uppercase waves pull-right waves-effect waves-float" title="Click here to add opening balance"><span class="btn-label"><i class="fa fa-plus-square"></i></span> Opening Balance</a>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            if (isset($_REQUEST['method']) && ($_REQUEST['method'] == 'add' || $_REQUEST['method'] == 'edit')) {
                  require_once 'forms/form_create_retailers_balance.php';
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-justified">
                                                        <div class="btn-group">
                                                            <button class="btn waves waves-effect waves-float btn-sm btn-<?php echo $Color; ?>" title="Click here to change status of this entry" onclick="ChangeStatus('<?php echo 'b_retailer_balance'; ?>', '<?php echo $Value['RetailerBalanceID']; ?>', '<?php echo $NewStatus; ?>','RetailerBalanceID', 'is_active','view_retailers_payment');"><i class="fa <?php echo $ICON; ?>"></i></button> 
                                                        </div>
                                                        <div class="btn-group">
                                                            <a class="btn waves waves-effect waves-float btn-sm btn-info" title="Click here to edit this entry" href="<?php echo  'view_retailers_payment&method=edit&RetailerBalanceID=' . $Value['RetailerBalanceID'] ;?>"><i class="fa fa-edit"></i></a>
                                                        </div>
                                                        <div class="btn-group">
                                                            <button class="btn waves waves-effect waves-float btn-sm btn-danger" title="Click here to remove this entry" onclick="DeleteSingleRecord('<?php echo 'b_retailer_balance'; ?>', '<?php echo $Value['RetailerBalanceID']; ?>', 'D','UserID', 'is_active','view_retailers_payment','b_retailer_balance','RetailerBalanceID,RetailerBalanceID');"><i class="fa fa-trash-o"></i></button>
