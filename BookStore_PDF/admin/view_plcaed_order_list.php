<?php
$PlaceOrderList = $fn->SelectAllPlacedOrdersData();
                                        ...
                                        foreach ($PlaceOrderList['GetPlacedOrderWiseData'] AS $Key => $Value) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($Value['OrderDeliveryStatus'] == "P"){ ?> 
                                                    <button class="btn waves waves-effect waves-float btn-sm btn-<?php echo $Color; ?>" title="Click here to Delived this Order" onclick="ChangeStatus('<?php echo 'b_order_master'; ?>', '<?php echo $Value['OrderID']; ?>', '<?php echo $NewStatus; ?>','OrderID', 'OrderDeliveryStatus','view_plcaed_order_list');"><i class="fa <?php echo $ICON; ?>"></i></button>
                                                    <a class="btn waves waves-effect waves-float btn-sm btn-default" href="view_order_wise_details&OrderNo=<?php echo $Value['OrderNo']; ?>&UserID=<?php echo $Value['UserID']?>" class="btn btn-normal">Print</a>
                                                    <button class="btn waves waves-effect waves-float btn-sm btn-danger" title="Click here to remove this entry" onclick="DeleteSingleRecord('<?php echo 'b_order_master'; ?>', '<?php echo $Value['OrderID']; ?>', 'D','OrderID', 'is_active','view_plcaed_order_list','b_order_master','OrderID,OrderID');"><i class="fa fa-trash-o"></i></button>
