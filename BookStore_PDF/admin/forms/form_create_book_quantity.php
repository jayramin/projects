...
//    $dataAll = $fn->GetAllBookData('{"BookID":'.$_REQUEST['BookID'].'}');
    $dataAll = $fn->GetQuantityDataByQuantityID('{"BookID":'.$_REQUEST['BookID'].'}');
    $data = $dataAll['GetQuantityWiseData'];
...
//                    $SelectedState123 = isset($data['StateID']) ? $data['StateID'] : "";
        ...
        <div class="col-lg-3">
                <div class="form-group">
                    <label for="purchase_amount" class="control-label">Cost Price</label>
                    <input type="number" min="0" name="purchase_amount" id="purchase_amount" value="<?php echo $data['purchase_amount']; ?>" class="form-control input-sm required" style="padding: 16px">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3">
            <div class="form-group">
                <label for="CategoryTitle" class="control-label"><?php echo Date; ?> <span style="color: red;">*</span> </label>
                <input type="date" name="PurchaseDate" id="PurchaseDate" value="<?php echo $data['PurchaseDate']; ?>" class="form-control input-sm required" >
            </div>
        </div>
            </div>
        <div class="row">
