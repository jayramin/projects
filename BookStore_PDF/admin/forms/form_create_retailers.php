...
//                    print_r($data);
                    ...
                    <div class="col-lg-10">
                        <div class="form-group">
                            ...
                            <input type="email" name="Email" id="Email" value="<?php echo $data['Email']; ?>" class="form-control input-sm required">
                        </div>
                    </div>
                    <div class="col-lg-10">
                        <div class="form-group">
                            <label for="MobileNumber" class="control-label"><?php echo MobileNumber; ?></label>
                            <input type="text" name="MobileNumber" id="MobileNumber" value="<?php echo $data['MobileNumber']; ?>" class="form-control input-sm required" onkeypress="return event.charCode > 47 && event.charCode < 58;"  maxlength="10">
                        </div>
                    </div>
                    <div class="col-lg-10">
                        <div class="form-group">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        ...
                        <?php } else { ?>
                            ...
                            <input type="button" name="create" id="create" value="<?php echo save; ?>" class="btn btn-primary btn-md" onclick="InsertAgentData(this.form, 'Retailer');" >
<?php } ?>
                        <a class="btn btn-primary btn-md" href="view_retailers_details">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
