...
echo "hello";
exit;
$RetailerOrderList = $fn->GetAllRetailerOrderData('{"Retailer":"'.$_REQUEST['Retailer'].'"}');
?>
<!--Content-->
...
//                        exit;
            ...
            <div class="col-lg-7">
                    ...
                    if ($_REQUEST['method'] == '') { ?>
                <a href='view_retailer_books&method=add' class="btn btn-sm btn-success btn-labeled text-uppercase waves pull-right waves-effect waves-float" title="Click here to add new record"><span class="btn-label"><i class="fa fa-plus-square"></i></span>  Add New</a>
                    <?php
                    }
