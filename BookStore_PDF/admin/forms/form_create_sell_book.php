        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <div class="form-group">
                    ...
                    <?php } ?>
                        <a class="btn btn-primary btn-md" href="view_add_clients&method=SellBook&ClientID=<?php echo $_REQUEST['ClientID']?>">Cancel</a>
                </div>
            </div>
        </div>
...
//                                            print_r($Value);
                                        ...
                                        ?>         
                                            ...
                                            <tr>
                                                <td colspan="7">
                                                    <label class="btn bt1 btn-primary btn-normal btn-inline " onclick="ClientPlaceOrder()"> Place Order</label>
                                                </td>
                                            </tr>
                                    </tbody>
                            </table>
