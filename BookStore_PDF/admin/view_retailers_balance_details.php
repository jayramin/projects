...
$RetailersBalanceList = $fn->GetRetailersBalanceData();
//echo "<pre>";
...
<div class="content-wrapper">
   <div class="row">
    <div class="page-title">
        ...
        <div class="col-lg-8">
                <div>
                <h1><i class="fa fa-dashboard"></i> Book Seller Balance Management</h1>
            </div>
            <div>
...
//exit;
                    ...
                    if ($_REQUEST['method'] == '') { ?>
                <div class="col-lg-12">
                    <a href='view_retailers_balance_details&method=add' class="btn btn-sm btn-success btn-labeled text-uppercase waves pull-right waves-effect waves-float" title="Click here to add new record"><span class="btn-label"><i class="fa fa-plus-square"></i></span>  Add Balance</a>
                </div>
<!--                <div class="col-lg-6">
