...
<?php } echo $ViewButton; ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <?php
            if (isset($_REQUEST['method']) && ($_REQUEST['method'] == 'OrderDetalis' || $_REQUEST['method'] == 'edit' || $_REQUEST['method'] == 'BillInfo')) {
                require_once './indivicual_user_invoice.php';
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered" id="sampleTable">
                                ...
                                <tbody>
                                    <?php
                                    $sr_no = 1;
                                    foreach ($RetailerList['GetGeneralUserData'] AS $Key => $Value) {
//                                            echo "<pre>";
//                                            print_r($Value);
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-justified">
                                                    <div class="btn-group">
                                                        <a class="btn waves waves-effect waves-float btn-sm btn-info" title="Click here to edit this entry" href="<?php echo 'general_user_invoice&method=OrderDetalis&UserID=' . $Value['UserID']; ?>">View Balance sheet<i class="fa fa-edit"></i></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
