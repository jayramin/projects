...
if (isset($_REQUEST['CityID']) && $_REQUEST['CityID'] != "") {
    $AreaList = $fn->GetAllAreasData('{"CityID":"' . $_REQUEST['CityID'] . '"}');
//    echo '<pre>';
//    print_r($AreaList);
}
?>
...
//                            $StateFilter = isset($data['CityID']) ? "is_active='Y'" : "is_active='Y'";
                        ...
                        $db_array = array("tbl_name" => 'b_city', "condition" => "is_active='Y' AND StateID = '" . $stateId . "'");
    ...
    <div class="row">
        <div class="col-lg-12">            
            ...
            if (isset($_REQUEST['method']) && ($_REQUEST['method'] == 'add' || $_REQUEST['method'] == 'edit')) {
                ...
                if ($AreaList['ResponseCode'] != 0 && $AreaList['Message'] != 'No Record Found') {
                    ?>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-justified">
                                                <div class="btn-group">
                                                    ...
                                                    <button class="btn waves waves-effect waves-float btn-sm btn-<?php echo $Color; ?>" title="Click here to change status of this entry" onclick="ChangeStatus('<?php echo 'b_city'; ?>', '<?php echo $Value['CityID']; ?>', '<?php echo $NewStatus; ?>', 'CityID', 'is_active', 'view_area&CityID=<?php echo $_REQUEST['CityID'] ?>');"><i class="fa <?php echo $ICON; ?>"></i></button>
                                                </div>
                                                <div class="btn-group">
                                                ...
                                                <div class="btn-group">
                                                    <button class="btn waves waves-effect waves-float btn-sm btn-danger" title="Click here to remove this entry" onclick="DeleteSingleRecord('<?php echo 'b_city'; ?>', '<?php echo $Value['CityID']; ?>', 'D', 'CityID', 'is_active', 'view_area&CityID=<?php echo $_REQUEST['CityID'] ?>', 'v_users', 'CityID');"><i class="fa fa-trash-o"></i></button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
