...
//echo "Hello";
//exit;
$RetailerList = $fn->GetAllRetailerData();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-justified">
                                                    <div class="btn-group">
                                                        <a class="btn waves waves-effect waves-float btn-sm btn-info" title="Click here to edit this entry" href="<?php echo 'view_retailer_books_orders&method=OrderDetalis&RetailerID=' . $Value['UserID']; ?>">Generate Bill <i class="fa fa-edit"></i></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
