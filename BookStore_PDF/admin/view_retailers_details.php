...
$RetailersList = $fn->GetAllRetailersData();
...
//exit;
                    ...
                    if ($_REQUEST['method'] == '') { ?>
                <a href='view_retailers_details&method=add' class="btn btn-sm btn-success btn-labeled text-uppercase waves pull-right waves-effect waves-float" title="Click here to add new record"><span class="btn-label"><i class="fa fa-plus-square"></i></span>  Add New</a>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            if (isset($_REQUEST['method']) && ($_REQUEST['method'] == 'add' || $_REQUEST['method'] == 'edit')) {
                  require_once 'forms/form_create_retailers.php';
            } else {
