    ...
    <div class="row">
        <div class="col-md-12">
            ...
            if (isset($_REQUEST['method']) && ($_REQUEST['method'] == 'OrderDetalis' || $_REQUEST['method'] == 'edit')) {
                  require_once 'forms/form_create_agent_books_orders.php';
...
<!--                                                        <div class="btn-group">
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <a class="btn waves waves-effect waves-float btn-sm btn-info" title="Click here to edit this entry" href="<?php echo  'view_agent_books_orders&method=OrderDetalis&AgentID=' . $Value['UserID'] ;?>">Add Books <i class="fa fa-edit"></i></a>
                                                        </div>
<!--                                                        <div class="btn-group">
