<?php
$data = $fn->DataByID('{"Condition":{"table":"v_documents","Key":"DocumentID","value":2}}');
?>
<!--Content-->
        ...
        <div class="col-lg-12">
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><?php echo ($_REQUEST['method']=='edit')?'Edit Privacy Policy':'View Privacy Policy'; ?></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class='panel-body'>
            <form class="content-form" id="form" name="form" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <button type="button" name="update" id="updateButton" class="btn btn-primary text-uppercase waves" onclick="update_data('<?php echo 'v_documents'; ?>', 'DocumentID', '2', 'view_privacy_policy', this.form);" ><?php echo save; ?></button>
