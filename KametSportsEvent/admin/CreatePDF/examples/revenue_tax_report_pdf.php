...
$pdf->SetSubject("Revenue And Tax Report");
...
$html = '<h1>Revenue And Tax Report For Tournament:-> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:green;">'.ucwords($Tournaments['TournamentName']).'</span></h1><table style="width:100%;" cellspacing="0" cellpadding="5" border="1">
                                <thead>
                                    <tr>
                                        <th>'.SrNo.'</th>
                                        <th>'.TeamName.'</th>
...
$FileName = 'Revenue And Tax For -'.ucwords($Tournaments['TournamentName']).' ' . date('Y-m-d H:i:s') . '.pdf';
ob_end_clean();
