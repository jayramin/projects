<?php
	$data = $fn->getDataByID("shopi_admin_users","user_id",$_REQUEST['user_id']);
?>
<section class="panel-body">
    ...
    <form action="" id="form" name="form" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        <label for="mname" class="control-label"><?php echo Mname ?> </label>
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="date" name="dob" id="dob" value="<?php echo $data['dob']; ?>" class="form-control input-sm">
                    </div>
                </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <textarea name="AddressLine1" id="AddressLine1" class="form-control input-sm"><?php echo $data['AddressLine1']; ?></textarea>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-2">
                <div class="form-group">
					...
					<input type="hidden" id="UserType" name="UserType" value="Y">
                    <?php if (isset($_REQUEST['user_id'])) { ?>
                        <input type="button" name="update" id="update" value="<?php echo update; ?>" class="btn btn-primary btn-sm " onclick="update_data('<?php echo 'shopi_admin_users'; ?>', 'user_id', '<?php echo $_REQUEST['user_id'] ?>', 'admin_user&method=edit&user_id=<?php echo $_REQUEST['user_id']; ?>', this.form);">
                    <?php } else { ?>
                        <input type="button" name="create" id="create" value="<?php echo save; ?>" class="btn btn-primary btn-sm " onclick="insert_data('<?php echo 'shopi_admin_users'; ?>', 'admin_user', this.form);">
                    <?php } ?>
                </div>
            </div>
        </div>
