        ...
        if (array_key_exists("method", array_change_key_case($_REQUEST, CASE_LOWER))) {
            ...
            if (method_exists($this->serviceClass, $method)) {
                ...
                if (count($pArray) == $pCount) {
                    ...
                    echo json_encode(array('ResponseCode'=>6,'Message' => "Required parameter(s) for " . $method . ": " . $paramStr));
                }
            } else {
                echo json_encode(array('ResponseCode'=>6,'Message' => "The method " . $method . " does not exist."));
            }
        } else {
            echo json_encode(array('ResponseCode'=>6,'Message' => 'No method was requested.'));
        }
    }
