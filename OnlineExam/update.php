...
if (isset($_SESSION['key'])) {
    if (@$_GET['q'] == 'addquiz' && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        ...
        $test_password =  rand();
        $link    = "http://www.svnkonlinetest.com/account.php?q=quiz&step=2&eid=5ea5413d272e9&n=1&t=2&pwd=".$test_password;
        $status  = "disabled";
        $id      = uniqid();
  
          $link    = "http://www.svnkonlinetest.com/account.php?q=quiz&step=2&eid=".$id."&n=1&t=".$total."&pwd=".$test_password."&start=start";
        $q3      = mysqli_query($con, "INSERT INTO quiz VALUES(NULL,'$id','$name','$correct','$wrong','$total','$time', 'NOW()','$status','$link','$test_password','$subject','$std','$chapter')");
