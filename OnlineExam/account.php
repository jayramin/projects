...
<div class="row">
<div class="col-lg-6">
<span class="logo">SVNK online test</span></div>
...
if (@$_GET['q'] == 'result' && @$_GET['eid']) {
    ...
    if ($status == "finished") {
        echo ' <section  id="content" > <div class="panel">
<center><h1 class="title" style="color:#660033">Hello  '.$username.'- Result</h1> <div id="editor"></div>
<button id="cmd" class="btn logb" style="color:#FFFFFF;background:darkgreen;font-size:12px;padding:5px;">Get PDF of Result</button> <center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
