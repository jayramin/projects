...
<title> Admin || SVNK online test</title>
...
if (@$_GET['q'] == 2)
    echo 'class="active"';
?>><a href="dash.php?q=2">Result</a></li>
    
        <li <?php
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="dash.php?q=4">Add Test</a></li>
        <li <?php
if (@$_GET['q'] == 5)
    echo 'class="active"';
?>><a href="dash.php?q=5">Remove Test</a></li>
      </ul>
          </div>
  </div>
</nav>
...
if (@$_GET['q'] == 0) {
    ...
    <table class="table table-bordered table-striped title1 table-responsive" id="ExamDetails"  >
    <thead>
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Quiz title</b></td><td style="vertical-align:middle"><b>Subject.</b></td><td style="vertical-align:middle"><b>std.</b></td> <td style="vertical-align:middle"><b>Chapter</b></td> <td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Status</b></td><td style="vertical-align:middle"><b>Action</b></td><td ><b> Link </b> </td> <td style="vertical-align:middle"> <b> Test Password </b> </td> </tr></thead>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        ...
        if ($status == "enabled") {
            echo '<tbody><tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $subject . '</td><td style="vertical-align:middle">' . $std . '</td><td style="vertical-align:middle">' . $chapter . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;min</td><td style="vertical-align:middle">Enabled</td>
  <td style="vertical-align:middle"><b><a href="update.php?deidquiz=' . $eid . '" class="btn logb" style="color:#FFFFFF;background:#ff0000;font-size:12px;padding:5px;">&nbsp;<span><b>Disable</b></span></a></b></td><td>'.$link.'</td> <td>' . $test_password .  '</td></tr>';
        } else {
            
            echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $subject . '</td><td style="vertical-align:middle">' . $std . '</td><td style="vertical-align:middle">' . $chapter . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;min</td><td style="vertical-align:middle">Disabled</td>
  <td style="vertical-align:middle"><b><a href="update.php?eeidquiz=' . $eid . '" class="btn logb" style="color:#FFFFFF;background:darkgreen;font-size:12px;padding:5px;">&nbsp;<span><b>Enable</b></span></a></b></td><td>'.$link.'</td> <td>' . $test_password .  '</td> </tr></tbody>';
...
<table class="table table-striped title1" id="result-table">
<thead>
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Roll number</b></td><td style="vertical-align:middle"><b>Score</b></td></tr></thead>';
    $c = $showfrom-1;
    ...
    if($total >= $showfrom){
        ...
        while ($row = mysqli_fetch_array($q)) {
            ...
            $c++;
            echo '<tbody><tr><td style="color:#99cc32"><b>' . $c . '</b><td style="vertical-align:middle">' . $username . '</td><td style="vertical-align:middle">' . $rollno . '</td><td style="vertical-align:middle">' . $s . '</td></tbody>';
        }
    }
    else{
    }
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Rollno</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Phno</b></td><td style="vertical-align:middle"></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $name      = $row['name'];
        $phno      = $row['phno'];
        ...
        echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $rollno . '</td><td style="vertical-align:middle">' . $username1 . '</td><td style="vertical-align:middle">' . $phno . '</td>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="subject" name="subject" placeholder="Enter subject title" class="form-control input-md" type="text">
    
  </div>
  </div>
  <div class="form-group">
  <label class="col-md-12 control-label" for="std"></label>  
  <div class="col-md-12">
  <input id="std" name="std" placeholder="Enter std here" class="form-control input-md" type="text">
    
  </div>
  </div>
  <div class="form-group">
  <label class="col-md-12 control-label" for="chapter"></label>  
  <div class="col-md-12">
  <input id="chapter" name="chapter" placeholder="Enter chapter title" class="form-control input-md" type="text">
