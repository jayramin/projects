...
function validateForm() {
  ...
  var a = document.forms["form"]["test_password"].value;
  if(a == null || a == ""){
...
<div class="row">
<div class="col-lg-6">
<span class="logo"><img src="image/logo.jpg" style="height: 54px;">  SVNK online test</span></div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <h3 align="center">Enter Test Details </h3>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your G.R.no (Ex.732116104***)" class="form-control input-md" autocomplete="off" type="text" value="<?php
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="username" name="username" placeholder="Choose a username" class="form-control input-md" autocomplete="off" type="username" value="<?php
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="phno" name="phno" placeholder="Enter your mobile number" class="form-control input-md" autocomplete="off" type="number" value="<?php
if (isset($_GET['phno']))
{
echo $_GET['phno'];
}
...
<div class="form-group">
 ...
 -->
<div class="form-group">
  <label class="col-md-12control-label" for="test_password"></label>
  <div class="col-md-12">
    <input id="test_password" name="test_password" placeholder="Enter test password" class="form-control input-md"  autocomplete="off" type="password">
...
<div class="form-group">
  ...
  <div class="col-md-12" style="text-align: center"> 
    <input  type="submit" value=" Start Now " class="btn btn-primary" style="text-align:center" />
  </div>
</div>
...
<div class="col-md-3 box">
<!--<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by webengine creation</a>-->
</div>
